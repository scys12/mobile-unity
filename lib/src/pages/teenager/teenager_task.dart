...
class TeenagerTask extends StatefulWidget {
  @override
  _TeenagerTaskState createState() => _TeenagerTaskState();
}

class _TeenagerTaskState extends State<TeenagerTask> {
  ...
  void initState() {
    super.initState();
    _child = Provider.of<Teenager>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return _loading ? Loading() : Scaffold(
      appBar: CustomAppBar(true, "Tantangan"),
      body: Container(
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: SubHeader(title: "Tantangan Lain",isLihatSemua: false,),
                  ),
                  Divider(thickness: 2.0,color: shadowColor,),
                  tasks.length <= 0 ? Padding(
                    padding: const EdgeInsets.symmetric(vertical: 20.0),
                    child: Text(
                      "Tidak ada tantangan lain",
                      style: TextStyle(
                          fontFamily: 'Poppins',
  ...
  Widget _buildAnother(){
    return Container(
      ...
      child: Column(
        children: [
          SubHeader(title: "Tantangan Lain",isLihatSemua: false,),
          SizedBox(height: 10.0,),
          ListView.builder(
            itemCount: 9,
            shrinkWrap: true,
          ...
          children: [
            Column(
              ...
              children: [
                ...
                SizedBox(height: 8.0,),
                Text(
                  "Selesaikan segera tantangan-tantangan \nagar mendapat poin",
                  style: TextStyle(
                      color: shadowColor,
                      fontSize: 16.0,
                      letterSpacing: 0.5
