...
class TeenagerTransactions extends StatefulWidget {
  @override
  _TeenagerTransactionsState createState() => _TeenagerTransactionsState();
}

class _TeenagerTransactionsState extends State<TeenagerTransactions> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return _loading ? Loading() : Scaffold(
      appBar: CustomAppBar(true, "Ringkasan"),
      body: Container(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 8.0,),
          Text(
            "Lihat kemana saja uang kamu digunakan",
            style: TextStyle(
                color: shadowColor,
                fontSize: 16.0,
                letterSpacing: 0.5
