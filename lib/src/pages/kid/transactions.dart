...
class KidTransactions extends StatefulWidget {
  @override
  _KidTransactionsState createState() => _KidTransactionsState();
}

class _KidTransactionsState extends State<KidTransactions> with TickerProviderStateMixin{
