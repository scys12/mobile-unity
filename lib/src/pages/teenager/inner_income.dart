                          ...
                          onPressed: () async {
                            ...
                            if(wishes.length > 0) {
                              ...
                              if (wishData["current_money"] >= wish.target) {
                                ...
                                teenagerData["total_point"] = _user.totalPoint + wish.point;
                              }
                            ...
                            returnContext ? Navigator.pop(context, 'Selamat, Harapan kamu sudah terkabul') : Navigator.pop(context, (route) => false);
                          },
                          style: ButtonStyle(
